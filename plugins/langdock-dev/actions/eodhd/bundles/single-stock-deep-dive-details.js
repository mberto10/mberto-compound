...
// headline_limit = Max rows in detailed news table (default: compact=20, full=newsLimit, min: 1, max: 200)
// catalyst_limit = Max rows per catalyst type (default: compact=20, full=60, min: 1, max: 200)
...
const headlineLimit = clampNumber(getCanonicalInput(input, 'headline_limit', INPUT_ALIASES.headline_limit, outputMode === 'compact' ? 20 : newsLimit, inputCompatibility), outputMode === 'compact' ? 20 : newsLimit, 1, 200);
const catalystLimit = clampNumber(getCanonicalInput(input, 'catalyst_limit', INPUT_ALIASES.catalyst_limit, outputMode === 'compact' ? 20 : 60, inputCompatibility), outputMode === 'compact' ? 20 : 60, 1, 200);
